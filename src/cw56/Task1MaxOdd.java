...
public class Task1MaxOdd {
  ...
  public static int DUMMY = 72353425;// DUMMY - заглушка.главное,чтоб такое число не встретилось)
   ...
   * @return индекс максимального нечётного числа или -1, если нечётных чисел нет
   */
  // Перезагрузка метода. Меняем в мейне Эррей на Линкед
  // в зависимомти от этого будет работать или то или то.
  // можно написать заглушку InstanceOf, тогда будет вызывать автоматически
